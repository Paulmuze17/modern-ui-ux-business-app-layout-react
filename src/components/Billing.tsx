		...
		<section id="product" className={layout.sectionReverse}>
			...
			<div className={`${layout.sectionInfo}`}>
				...
				<div className="flex flex-row flex-wrap sm:st-10 gap-5 pt-6">
					<button className="w-[128px] h-[42px] rounded-sm outline hover:outline-2 hover:outline-secondary transition-outline duration-300"><img className="object-contain w-full h-full" src={apple} alt="ios store" /></button>
					<button className="w-[128px] h-[42px] rounded-sm outline hover:outline-2 hover:outline-secondary transition-outline duration-300"><img className="object-contain w-full h-full" src={google} alt="google play" /></button>
				</div>
			</div>
		</section>
	)
